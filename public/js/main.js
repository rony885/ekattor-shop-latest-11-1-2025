...
(function ($) {
  ...
  setInterval(function time() {
    ...
    jQuery(".timer-section1 ul").html(
      '<li class="clock-li"><span class="clock-timer">' +
        days +
        '</span><span class="clock-title">Day</span></li><li class="clock-li"><span class="clock-timer">' +
        hours +
        '</span><span class="clock-title">Hrs</span></li><li class="clock-li"><span class="clock-timer">' +
        min +
        '</span><span class="clock-title">Min</span></li><li class="clock-li"><span class="clock-timer">' +
        sec +
        '</span><span class="clock-title">Sec</span></li>'
    );
  }, 1000);
  ...
  /*====================================
    ...
    ====================================*/
  $(
    ".cart-wrapper a.js-cart-drawer,  .bottom-menu-wrapper a.bottom-menu-cart, a.add-to-cart, .bottom-menu-cart"
  ).on("click", function () {
  ...
  if ($("ul.offer-text-ul li.offer-text-li").length) {
    addEventListener("DOMContentLoaded", (event) => {
      var slides = document.querySelectorAll(
        "ul.offer-text-ul li.offer-text-li"
      );
      var currentSlide = 0;
  ...
  $(".list-change-view").on("click", function () {
    ...
    if (
      $(".special-product").hasClass("grid-1") ||
  ...
  jQuery(document).ready(function () {
    ...
    $("#home-slider .owl-dot")[0].innerHTML =
      '<div class="inner"></div><div class="bar left-bar"><div class="progress-wrap"></div></div><div class="bar right-bar"><div class="progress-wrap"></div></div>';
    owl.owlCarousel();
  ...
  WT.animateTemplate = {
    ...
    registerAnimation: function () {
      var $at = this;
      $("[data-animate]:not(.animate__animated)", $at.aBody).waypoint(
        function () {
  ...
  $(".style3-slider-small").slick({
    ...
    nextArrow:
      '<button class="slick-next"><i class="fa-solid fa-arrow-right"></i></i></button>',
    dots: false,
    centerMode: true,
