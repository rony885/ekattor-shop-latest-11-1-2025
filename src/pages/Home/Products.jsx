                ...
                <div className="collection-wrap">
                  <Slider {...settings}>
                    {products.map((product) => (
                      <div key={product.id} className="single-product-wrap">
                        <div className="product-image">
                          <Link to={`/product-details/${product.id}`} className="pro-img">
                            <img src={product.img1} className="img-fluid img1" alt={product.title} />
                            <img src={product.img2} className="img-fluid img2" alt={product.title} />
                          </Link>
